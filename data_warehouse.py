...
def getNamesOfCities(filename):
    ...
    df['city_name'] = df['nazwa miasta'].str.lower() + ' ' + df['nazwa województwa'].str.lower()

    # replace polish special letters
    df['city_name'] = df['city_name'].str.replace('ś', 's')
    df['city_name'] = df['city_name'].str.replace('ż', 'z')
    df['city_name'] = df['city_name'].str.replace('ź', 'z')
    df['city_name'] = df['city_name'].str.replace('ą', 'a')
    df['city_name'] = df['city_name'].str.replace('ę', 'e')
    df['city_name'] = df['city_name'].str.replace('ć', 'c')
    df['city_name'] = df['city_name'].str.replace('ó', 'o')
    df['city_name'] = df['city_name'].str.replace('ł', 'l')
    df['city_name'] = df['city_name'].str.replace('ń', 'n')
